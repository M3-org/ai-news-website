...
import { CANVAS_SIZE, type NodePos } from "./layout";
import {
  interpolateCamera,
  cameraTransform,
  ZOOM,
...
import { DATE_FRAMES, OUTRO_FRAMES, OPENING_FRAMES } from "../timing";
import { buildGraphTimeline, SCAN_FRAMES, FADE_OUT_FRAMES, type GraphTimeline, type Seg, type SegType } from "./timeline";
