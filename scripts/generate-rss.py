...
WORKSPACE_ROOT = SCRIPT_DIR.parent  # ai-news-website root
KNOWLEDGE_ROOT = Path(os.environ.get("KNOWLEDGE_ROOT", WORKSPACE_ROOT / "knowledge"))
FACTS_DIR = KNOWLEDGE_ROOT / "the-council" / "facts"
COUNCIL_DIR = KNOWLEDGE_ROOT / "the-council" / "council_briefing"
RETROS_DIR = KNOWLEDGE_ROOT / "the-council" / "retros"
OUTPUT_DIR = WORKSPACE_ROOT / "rss"
SITE_URL = os.environ.get("SITE_URL", "https://elizaos.news")
